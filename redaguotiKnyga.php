...
<h1 class="antraste">Knygų koregavimas</h1>
<div class="remai">
<div class="lentele">
...
$sql="UPDATE knygos SET pavadinimas=' $pavadinimas', santrauka='$santrauka', ISBN='$ISBN',
 nuotrauka ='$failoVieta', pslSk ='$skaicius', kategorijosID ='$KnygKategorija' WHERE ID='$id';";
    ...
    echo "<br><br><a href=administracija.php>Grįžti į administracijos puslapį</a>";
  }catch (PDOException $e){
