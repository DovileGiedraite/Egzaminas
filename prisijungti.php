...
Slaptažodis: <input type="password" name="slaptazodis"><br><br>      
...
if($_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    try {
        ...
        $sql = "SELECT ID, vardas, tipas, kodSlaptazodis FROM vartotojai WHERE vardas=:vardas1;";
        ...
        if(count($rezultatas) > 0) {
            ...
            if(password_verify($vartotojoSlapt, $gautasSlaptazodis)) {
                ...
                echo "Neteisingas slaptažodis arba prisijungimo vardas.";
            }
